...
object RV64IM extends HasInstrType {
  ...
  def BEQ     = BitPat("???????_?????_?????_000_?????_1100011")
  def BNE     = BitPat("???????_?????_?????_001_?????_1100011")
  def BLT     = BitPat("???????_?????_?????_100_?????_1100011")
  def BGE     = BitPat("???????_?????_?????_101_?????_1100011")
  def BLTU    = BitPat("???????_?????_?????_110_?????_1100011")
  def BGEU    = BitPat("???????_?????_?????_111_?????_1100011")
