...
class CTRL extends Module {
  ...
  io.stallPc     := !io.lsuReady | loadUse | (io.icStall & !io.branch) | !io.exuReady | io.exuCsr | io.lsuCsr | io.wbuCsr | io.brUse
  ...
  io.flushExuReg := loadUse | io.exuCsr | io.lsuCsr | io.wbuCsr | io.brUse
}
