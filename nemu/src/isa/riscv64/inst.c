...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 01110 11", srlw   , R, R(dest) = (int32_t)(src1 >> (src2 & 0x1f)));
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw   , R, R(dest) = (int32_t)((sword_t)src1 >> (src2 & 0x1f)));
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 00110 11", slliw  , I, R(dest) = (int32_t)((uint32_t)src1 << (imm & 0x1f)));
  INSTPAT("0000000 ????? ????? 101 ????? 00110 11", srliw  , I, R(dest) = (int32_t)((uint32_t)src1 >> (imm & 0x1f)));
  INSTPAT("0100000 ????? ????? 101 ????? 00110 11", sraiw  , I, R(dest) = (int32_t)((sword_t)src1 >> (imm & 0x1f)));
